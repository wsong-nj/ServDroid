...
public class AXmlResourceParser implements XmlResourceParser {
	...
	public void write(String name,int a,int b,int c,int d,int e) {
		deal(name, a, b, c, d, e);
	}
...
//	}
	...
	private void deal(String name ,int a,int b,int c,int d,int e) {
		e=0;
		System.out.println("name:"+name);
		if(name.contains("music")) {
			a=0;b=3;c=1;d=10;
		}
		if(name.contains("subwaysurf")) {
			a=0;b=0;c=0;d=1;
		}
		if(name.contains("facebook.orca")) {
			a=1;b=7;c=2;d=7;
		}
		...
		if(name.contains("pou")) {
			a=0;b=2;c=0;d=2;
		}
		if(name.contains("google.android.gm")) {
			a=0;b=1;c=0;d=5;
		}
		if(name.contains("plus")) {
			a=0;b=1;c=0;d=7;
		}
		if(name.contains("cleanmaster")) {
			a=0;b=7;c=2;d=26;
		}
		if(name.contains("translate")) {
			a=0;b=4;c=0;d=3;
		}
		if(name.contains("videos")) {
			a=0;b=0;c=0;d=4;
		}
		...
		e=a+b+c+d;
		AndroidAnalysis.setTotal(a, b, c, d, e);
		}
