...
public class IntraMethodAnalysis {
	...
	public Body body;
	public Chain<Unit> chain;
	public static UnitGraph unitGraph;
...
//	}
	...
	public static List<Unit> getPostDominatorsByUnit(Unit unit){
		
		return new MHGPostDominatorsFinder<Unit>(unitGraph).getDominators(unit);
