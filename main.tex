...
Our design favors scalability over large real-world apps by using a
context-insensitive inter-procedural control flow analysis.

Since some services declared in the AndroidManifest file of the app may not
...
are use cases of the services that may lead to corresponding service usage inefficiencies based on
